...
def _build_case(ndivs=4, order=4, table="table1", flux_type="upwind", velocity_volume=None, velocity_face=None):
...
def test_surface_cache_shapes():
    mesh, ref, conn, geom, trace, full = _build_case(ndivs=4, order=4)
...
def test_constant_field_surface_correction_zero_upwind():
    mesh, ref, conn, geom, trace, full = _build_case(ndivs=4, order=4, flux_type="upwind")
...
def test_constant_field_surface_correction_zero_central():
    mesh, ref, conn, geom, trace, full = _build_case(ndivs=4, order=4, flux_type="central")
...
def test_constant_field_surface_correction_zero_lf():
    mesh, ref, conn, geom, trace, full = _build_case(ndivs=4, order=4, flux_type="lf")
